          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-900">
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="bg-blue-400 rounded px-3 py-1.5 hover:text-gray-900 font-medium" href="tel:+61458618302">
                    0458 618 302
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="bg-blue-400 rounded px-3 py-1.5 hover:text-gray-900 font-medium" href="mailto:info@jestinautoelectrics.com">
